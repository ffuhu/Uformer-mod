...
#python3 ./train.py \
#  --env deblur_SGgenMVDS_TRIALS_MetaUFORMER_conv1x1_wind_pool_BAR_bs4 \
#  --arch MetaUformer \
#  --batch_size 4 \
#  --gpu "7" \
#  --train_ps 64 \
#  --nepoch 75 \
#  --train_dir /home/ffuentes/Scratch/nus/24-data-efficient-gans/DiffAugment-stylegan2-pytorch/training-runs/00009--low_shot-color-translation-cutout_ABdiff_ps128px/out/ \
#  --val_dir /home/ffuentes/Scratch/nus/24-data-efficient-gans/DiffAugment-stylegan2-pytorch/training-runs/00009--low_shot-color-translation-cutout_ABdiff_ps128px/out/ \
#  --embed_dim 16 \
#  --warmup \
#  --train_workers 8 \
#  --eval_workers 4 \
...
## todo: finetuning SGgenMVDS with manually_selected_5_2 wind_pool
#python3 ./train.py \
#  --env deblur_SGgenMVDS_TRIALS_MetaUFORMER_conv1x1_wind_pool_BAR_bs4_FT_MVDSmanually_selected_5_2_bs4_dmult480_ep1500_ps64 \
#  --arch MetaUformer \
#  --batch_size 4 \
#  --gpu "7" \
#  --train_ps 64 \
...
#  --eval_workers 4 \
#  --use_mixup_from_epoch 6 \
#  --pretrain_weights /home/ffuentes/Scratch/nus/20_deblurring_uformer/log/MetaUformerdeblur_SGgenMVDS_TRIALS_MetaUFORMER_conv1x1_wind_pool_BAR_bs4/models/model_best.pth \
#  --resume \
#  --reset_optimizer \
#  --token _down \
#  --token_mixing wind_pool \
...
## TEST NO SGAN DATA
#python3 ./train.py \
#  --env deblur_MVDSmanually_selected_5_2 \
#  --arch Uformer \
#  --batch_size 4 \
#  --gpu "0" \
#  --train_ps 64 \
...
# RUNNING NOW (211222_1039)
# todo: finetuning MetaUformerdeblur_SGgenMVDS_TRIALS_MetaUFORMER_LeFF_WindAttn_ASUS_bs4
python3 ./train.py \
  --env deblur_SGgenMVDS_TRIALS_MetaUFORMER_LeFF_WindAttn_BAR_bs4 \
  --arch MetaUformer \
  --batch_size 4 \
  --gpu "7" \
  --train_ps 64 \
  ...
  --eval_workers 4 \
  --use_mixup_from_epoch 6 \
  --token_mixing wind_attn \
  --token_mlp leff

# RUNNING NOW (211222_1039)
# todo: finetuning MetaUformerdeblur_SGgenMVDS_TRIALS_MetaUFORMER_LeFF_WindAttn_ASUS_bs4 with manually_selected_5_2 WindAttn
python3 ./train.py \
  --env deblur_SGgenMVDS_TRIALS_MetaUFORMER_LeFF_WindAttn_BAR_bs4_FT_MVDSmanually_selected_5_2_bs4_dmult480_ep1500_ps64 \
  --arch MetaUformer \
  --batch_size 4 \
  --gpu "7" \
  --train_ps 64 \
  ...
  --eval_workers 4 \
  --use_mixup_from_epoch 6 \
  --pretrain_weights /home/ffuentes/Scratch/nus/20_deblurring_uformer/log/MetaUformerdeblur_SGgenMVDS_TRIALS_MetaUFORMER_LeFF_WindAttn_BAR_bs4/models/model_best.pth \
  --resume \
  --reset_optimizer \
  --token _down \
  --token_mixing wind_attn \

...
#python3 ./train.py \
#  --env deblur_SGgenMVDS_TRIALS_MetaUFORMER_LeFF_Pool_BAR_bs4 \
#  --arch MetaUformer \
#  --batch_size 4 \
#  --gpu "6" \
#  --train_ps 64 \
...
python3 ./train.py \
  --env deblur_SGgenMVDS_TRIALS_MetaUFORMER_LeFF_Pool_BAR_bs4_FT_MVDSmanually_selected_5_2_bs4_dmult480_ep1500_ps64 \
  --arch MetaUformer \
  --batch_size 4 \
  --gpu "6" \
  --train_ps 64 \
  ...
  --eval_workers 4 \
  --use_mixup_from_epoch 6 \
  --pretrain_weights /home/ffuentes/Scratch/nus/20_deblurring_uformer/log/MetaUformerdeblur_SGgenMVDS_TRIALS_MetaUFORMER_LeFF_Pool_BAR_bs4/models/model_best.pth \
  --resume \
  --reset_optimizer \
  --token _down \
  --token_mixing pool \
